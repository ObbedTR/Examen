...
<div class="card mb-3" style="max-heihgt: 540px;">
  <div class="row no-gutters">
    <div class="col-md-4">
      <img src="https://pbs.twimg.com/media/DRWvSy3XUAAq_7y.jpg" class="card-img" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
      <a href="/koi"><h5 class="card-title">Koi Samsa</h5> </a>
        <p class="card-text">
...
<div class="card mb-3" style="max-heihgt: 540px;">
  <div class="row no-gutters">
    <div class="col-md-4">
      <img src="https://images.squarespace-cdn.com/content/v1/58b1be81d1758e01328ce8bb/1561988015794-Y5L9VMWGWM1ANWYQFBZE/ke17ZwdGBToddI8pDm48kF8BL7ExAzp1lS4ODMnDRmxZw-zPPgdn4jUwVcJE1ZvWQUxwkmyExglNqGp0IvTJZUJFbgE-7XRK3dMEBRBhUpzJS46bAGw0Mcvc3hYFlJZoy81S2xjX169l3_O9Qykt-9FwdHWSXQnLT9Hyk6rbhDY/AM-DeBrincat_BloomingSky.jpg?format=750w" class="card-img" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
<a href="/am">        <h5 class="card-title">AM DeBrincat (Karen Mainenti)</h5>
</a>        <p class="card-text">
            _id: 5ed8175a91abbafcb010a22f <br>
            Estadounidense <br>
            Corriente: Moderno-Mixed Media Technique <br>
            Ha sido artista residente en el Museo de Arte Contemporáneo de Massachusetts (MASS MoCA), Chashama y el Proyecto Wassaic, y ha recibido subvenciones y fondos del Museo de Arte Contemporáneo de Massachusetts, la Fundación Durst y el Fondo Deming.
        <p class="card-text"><small class="text-muted"><em>"But now when I see it, I just think of meditation and how much peace and joy it’s brought me."</em></small></p>
      </div>
    </div>
  </div>
</div>
...
<div class="row no-gutters">
  ...
  <div class="col-md-8">
    <div class="card-body">
<a href="/elly">      <h5 class="card-title">Elly Smallwood</h5>
</a>      <p class="card-text">
...
<div class="card mb-3" style="max-heihgt: 540px;">
  <div class="row no-gutters">
    <div class="col-md-4">
      <img src="https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/edf00730248953.561a99826290b.jpg" class="card-img" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
<a href="/jaime">        <h5 class="card-title">Jaime Ruíz</h5>
</a>        <p class="card-text">
...
<div class="card mb-3" style="max-heihgt: 540px;">
  <div class="row no-gutters">
    <div class="col-md-4">
      <img src="https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/f6b7a440777793.578d1c36cc12d.jpg" class="card-img" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
<a href="/liam">        <h5 class="card-title">La Rouille (Liam Decay)</h5>
</a>        <p class="card-text">
